...
--this is not a streaming live table. its a static live table for lookup
...
AS
  ...
  FROM STREAM(LIVE.orders_raw) o --STREAM() indicate is as a streaming delta live table
...
AS
  ...
  FROM LIVE.orders_cleaned --if we remove LIVE here, this cell run wont fail in the notebook. But will fail in the pipeline
  WHERE country = "China"
